...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        ItensDao.createTable(db, ifNotExists);
        Request_itensDao.createTable(db, ifNotExists);
        RequestsDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        CategoriesDao.dropTable(db, ifExists);
        ItensDao.dropTable(db, ifExists);
        Request_itensDao.dropTable(db, ifExists);
        RequestsDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(ItensDao.class);
        registerDaoClass(Request_itensDao.class);
        registerDaoClass(RequestsDao.class);
    }
